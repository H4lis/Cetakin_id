...
<body>
    ...
    <header class="navbar sticky-top bg-dark flex-md-nowrap p-0 shadow" data-bs-theme="dark">
        <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3 fs-6 text-white" href="/Cetakin/\">Cetakin.id</a>
                    ...
                    <table class="table table-striped table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col">Actions</th> <!-- Kolom baru untuk tombol edit dan delete -->
                            </tr>
                        </thead>
                        ...
                        <tbody>
                            <?php foreach ($produk as $row): ?>
                                <tr>
                                    ...
                                    <td><img width="50px" src="img/products/<?= $row["image_path"]; ?>" alt="">
                                    </td>
                                    <td>
                                        <?php
                            ...
                            <?php endforeach; ?>
                            <!-- Tambahkan baris yang sama untuk setiap data lainnya -->
                        </tbody>
                    </table>
                </div>
                <div class="container mt-2">
                    <h1 class="h2">Buat Data </h1>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control " name="deksripsi" autocomplete="off"
